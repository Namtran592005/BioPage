import React, { useState, useEffect, useRef } from 'react'; // Giữ nguyên useRef
...
const PersonalLandingPage = () => {
  ...
  // XÓA HOÀN TOÀN các state liên quan đến custom cursor: trail, cursorRef
  // XÓA HOÀN TOÀN các useEffect liên quan đến custom cursor
  ...
  const handleConnectionCheckClick = async () => {
    ...
    try {
      ...
      setConnectionData(prevData => ({ ...prevData, securityRating })); // Đảm bảo merge vào state cũ
              ...
              <div className="connection-info">
                ...
                {connectionStatus === 'success' && connectionData && (
                  <div className="modal-grid">
                    ...
                    <div className="modal-data-group">
                      <label>IPv6:</label>
                      <span>{connectionData.ipv6 || "Không có"}</span>
                    </div>
                    <div className="modal-data-group">
                      <label>Ping:</label>
